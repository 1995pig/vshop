		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<table class="table table-hover table-condensed">
					<tbody>
						<tr>
							<td class="text-center" rowspan="7" style="width:30%"><img id="modal-photo"  style="height:20%;width:80%"></td>
						...
						<tr>
							<td class="text-center" colspan="3">
								<pre id="modal-note" class="pre-scrollable" style="height:100px;width:600px;">
 								</pre>
							</td>
						</tr>
					</tbody>
