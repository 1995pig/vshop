...
<%!
 	public static final String DETAILS_URL = "pages/front/center/orders/OrderActionFront!details.action";
%>
<body class="back">
									...
									<c:forEach items="${allOrders }" var="orders">
									 	<tr>
											...
											<td class="text-center"> 
												<a type="button" class="btn btn-primary btn-xs" href="<%=DETAILS_URL%>?oid=${orders.oid}">
